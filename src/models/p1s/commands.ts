 ...
 * @return The command payload to send to the printer.
 */
export function pushAllCommand() {
	return {
		pushing: {
			sequence_id: "0",
			command: "pushall",
...
/**
 * Generate the command for stopping the current print job.
...
/**
 * Generate the command for pausing the current print job.
 * @returns The command payload to send to the printer.
 */
...
/**
 * Generate the command for resuming the current print job.
 * @returns The command payload to send to the printer.
 */
